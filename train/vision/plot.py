...
loss_val_list5 = []
acc_val_list5 = []
with open('../log/mobile_256.txt', 'r') as file:
...
with open('../log/mobile_2048.txt', 'r') as file:
    for line in file.readlines():
        line = line.strip().split("  ")
...
loss_train_256_percent =  [x/loss_train_list1[0] for x in loss_train_list]
loss_train_1024_percent = [x/loss_train_list1[0] for x in loss_train_list1]
plt.plot(iter_list, loss_train_256_percent, '--', label="kn = 256, lr = 0.1, 5.1%")
plt.plot(iter_list, loss_train_1024_percent, '-.', label="kn = 2048, lr = 0.8, 5.3%")
...
# plt.plot(iter_list, acc_train_list, '--', label="256")
# plt.plot(iter_list, acc_train_list1, '-.', label="1024")
...
# plt.plot(iter_list, loss_val_list, '--', label="256")
# plt.plot(iter_list, loss_val_list1, '-.', label="1024")
...
# plt.plot(iter_list, acc_val_list, '--', label="256")
# plt.plot(iter_list, acc_val_list1, '-.', label="1024")
