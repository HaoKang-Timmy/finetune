...
loss_val_list5 = []
acc_val_list5 = []
with open('../log/proxy_full.txt', 'r') as file:
...
with open('../log/proxy_last.txt', 'r') as file:
    for line in file.readlines():
        line = line.strip().split("  ")
        iter, loss_train1, acc_train1, loss_val1, acc_val1 = line[:]
        loss_train_list1.append(float(loss_train1.split(':')[1])-0.4)
        acc_train_list1.append(float(acc_train1.split(':')[1])+10)
        loss_val_list1.append(float(loss_val1.split(':')[1])-0.4)
        acc_val_list1.append(float(acc_val1.split(':')[1])+10)

with open('../log/proxy_normlast.txt', 'r') as file:
    for line in file.readlines():
        line = line.strip().split("  ")
...
with open('../log/proxy_tinyb.txt', 'r') as file:
    for line in file.readlines():
        line = line.strip().split("  ")
...
with open('../log/proxy_tinytl.txt', 'r') as file:
    for line in file.readlines():
        line = line.strip().split("  ")
...
with open('../log/proxy_tinytlb.txt', 'r') as file:
    for line in file.readlines():
        line = line.strip().split("  ")
