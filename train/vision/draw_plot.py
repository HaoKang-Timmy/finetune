...
# loss_val_list2 = []
# acc_val_list2 = []
with open('../log/tune_adam.txt', 'r') as file:
...
plt.plot(iter_list, loss_train_list, label="Adam")
plt.plot(iter_list, loss_train_list1, label="Adamw")
...
plt.plot(iter_list, acc_train_list, label="Adam")
plt.plot(iter_list, acc_train_list1, label="Adamw")
...
plt.plot(iter_list, loss_val_list, label="Adam")
plt.plot(iter_list, loss_val_list1, label="Adamw")
...
plt.plot(iter_list, acc_val_list, label="Adam")
plt.plot(iter_list, acc_val_list1, label="Adamw")
